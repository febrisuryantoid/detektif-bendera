      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-pop-in">
        <div className="relative w-[90%] max-w-sm bg-white rounded-[2rem] border-[6px] border-sky-500 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
          ...
          <div className="bg-sky-500 p-4 text-center shrink-0">
            <h2 className="text-2xl font-extrabold text-white font-display tracking-wider uppercase drop-shadow-md">
              {t.about.title}
            </h2>
          </div>

          <div className="p-4 overflow-y-auto custom-scrollbar flex-1 font-sans">
            ...
            <div className="bg-indigo-50 rounded-2xl p-4 border-2 border-indigo-100 mb-4 text-center transition-colors relative">
              ...
              <h3 className="text-xl font-black text-indigo-900 font-display leading-none">Febri Suryanto</h3>
              <p className="text-[10px] font-bold text-indigo-600 mt-1 mb-4">{t.about.job}</p>
              ...
              <a 
                ...
                className="
                  w-full bg-indigo-500 text-white font-semibold py-2.5 rounded-xl 
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="font-bold text-gray-700 text-xs uppercase tracking-wide">{t.about.assets}</h4>
              </div>

              <div className="grid gap-2">
                <CreditItem icon={<Palette size={14} className="text-pink-500" />} title={t.about.fonts} desc="Baloo 2 & Poppins" bg="bg-pink-50" border="border-pink-100" />
          ...
          <div className="p-4 bg-gray-50 border-t-2 border-gray-100 flex flex-col gap-2 shrink-0 font-sans">
            ...
            <button 
              onClick={handleClose}
              className="w-full bg-sky-500 text-white font-bold py-3 rounded-xl border-b-4 border-sky-700 active:border-b-0 active:translate-y-1 transition-all shadow-md btn-3d"
            >
              {t.about.btnClose}
            </button>
          </div>
